...
export default function HeroSection() {
  ...
  return (
    <>
      {/* section 1 */}
      <div
        className="relative w-[750px] h-[660px] md:w-[1520px] md:h-screen p-4 mt-1 bg-cover bg-center bg-no-repeat"
        style={{
      ...
      >
        <div className="p-4 flex flex-col justify-center items-center font-bold text-2xl space-y-7 shadow-lg shadow-amber-300 md:p-8 mt-[180px] md:mt-[200px]">
          <div className="md:text-4xl">
            LET&apos;S <span className="text-green-500">GRIND</span> YOUR BODY
          </div>
          <div className="flex flex-col justify-center items-center space-y-4 md:text-2xl ">
            <p>
              GET FIT WITH <span className="text-green-500">FITZONE</span>
            </p>
            <button className="text-black bg-green-700  hover:cursor-pointer hover:bg-green-600 hover:font-semibold p-2 rounded-lg shadow-lg shadow-green-200">
              <Link href="/plans">Become a member</Link>
            </button>
          </div>
        </div>
      </div>
      ...
      <div className="p-8 bg-white text-black">
        <h1 className="text-2xl md:text-3xl font-bold">
          WHY <span className="text-green-500">FITNESS</span> IS IMPORTANT ?
        </h1>
      ...
      {/* section 3 */}
      <div
        className="relative w-[750px] h-64 md:w-[1520px] md:h-[350px] p-4 mt-1 bg-cover bg-center bg-no-repeat shadow-lg shadow-gray-800"
      ...
      >
        <div className="p-4 flex flex-col justify-center items-center font-bold text-2xl space-y-7 shadow-lg shadow-amber-300 md:mt-10 md:p-8">
          <div className="md:text-2xl">
            Your <span className="text-green-500">body</span> can do it
          </div>
          <div className="flex flex-col justify-center items-center space-y-4 md:text-2xl ">
            <p>
              It&apos;s time to convince your{" "}
